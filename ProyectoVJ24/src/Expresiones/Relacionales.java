...
public class Relacionales extends Instrucciones{
    private Instrucciones cond1;
    private Instrucciones cond2;
    private OperadoresRelacionales relacional;

    public Relacionales(Instrucciones cond1, Instrucciones cond2, OperadoresRelacionales relacional, int linea, int col) {
